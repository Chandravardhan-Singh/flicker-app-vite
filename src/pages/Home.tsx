    ...
    <div className="main">
      {/* <Grid container spacing={2}>
        <Grid item xs={12} sm={5} md={6} lg={4}>
          <Card>md=6 sm=12 lg=4</Card>
        </Grid>
        <Grid item xs={12} sm={7} md={6} lg={8}>
          <Card>md=6 xs=12 lg=8 </Card>
        </Grid>
      </Grid> */}
            ...
            <Grid item xs={12} sm={6} lg={4} md={6}>
              ...
              >
                ...
                <CardContent>
                  ...
                  <Typography>
                    Best in world for delivery fastest and safest with hightest
                    Air Shipping all over the world.
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
          ...
          <Grid container spacing={1} marginTop={10} marginLeft={0}>
            ...
            <Grid item lg={4} md={12} xs={12} sm={12} mt={5}>
              ...
              <Typography variant="subtitle1" component={"p"} color={"#fff"}>
                ...
                Obcaecati a quia reprehenderit vitae? Placeat sint minus laborum
                accusamus eos atque quia odit illum ipsum perspiciatis. Dolores,
                dicta. Ea, assumenda blanditiis!
              </Typography>
            </Grid>
            ...
            <Grid item lg={2} md={4} xs={6} sm={6} mt={5}>
              <List dense component={"a"}>
                ...
                <ListItemButton>
                  <ListItemText primary="Cookie Policy" className="list-item" />
                </ListItemButton>
              </List>
            </Grid>
